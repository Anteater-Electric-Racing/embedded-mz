...
//PID controller struct and functions, can be used for any PID controller but make sure to 
//set limits for integral windup based on the setpoint you are trying to achieve.
typedef struct {
    float integral;
    float prevError;
    float prevOutput;
