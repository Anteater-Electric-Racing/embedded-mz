...
static void threadMCU(void *pvParameters) {
    while (true) {
        ...
        case mMCU3_ID: {
            ...
            taskENTER_CRITICAL(); // Enter critical section
            mcu3Data = {
                .mcuVoltage = CHANGE_ENDIANESS_16(mcu3.MCU_DC_MainWireVolt) *
                              0.01F, // convert to V
                .mcuCurrent = CHANGE_ENDIANESS_16(mcu3.MCU_DC_MainWireCurr) *
                              0.01F, // convert to A
                .motorPhaseCurr = CHANGE_ENDIANESS_16(mcu3.MCU_MotorPhaseCurr) *
                                  0.01F, // convert to A
            };
            taskEXIT_CRITICAL(); // Exit critical section
            break;
