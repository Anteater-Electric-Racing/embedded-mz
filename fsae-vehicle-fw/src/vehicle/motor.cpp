...
void threadMotor(void *pvParameters) {
    while (true) {
        ...
        case MOTOR_STATE_DRIVING: {
            ...
            bms2.sAllowMaxDischarge = CHANGE_ENDIANESS_16(
                maxDischarge); // Convert to little-endian format
        ...
        case MOTOR_STATE_FAULT: {
            ...
            bms1.Pre_charge_Relay_FB =
                1; // 1 = ON, 0 = OFF NOTE: see if we can omit this bit
            bms1.Pre_charge_Finish_Sts = 1; // 1 = ON, 0 = OFF
            vcu1.VCU_Warning_Level =
                1; // 0 = No Warning, 1 = Warning, 2 = Fault, 3 = Critical Fault
            vcu1.VCU_MotorMode = 0; // 0 = Standby, 1 = Drive, 2 = Generate
